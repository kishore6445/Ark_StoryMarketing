...
export function PKRAnalyticsDashboard({
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl p-12 border border-gray-200 flex items-center justify-between">
        <div>
          <p className="text-sm font-semibold text-gray-600 uppercase tracking-wider mb-3">Overall PKR</p>
          <p className="text-6xl font-bold text-gray-900 mb-6">{overallPKR}%</p>
          <div className="space-y-2 text-sm text-gray-600">
            <p>{keptPromises} of {totalPromises} promises kept</p>
            <p className="text-red-600 font-medium">{missedPromises} missed, {atRiskPromises} at risk</p>
          </div>
        </div>
